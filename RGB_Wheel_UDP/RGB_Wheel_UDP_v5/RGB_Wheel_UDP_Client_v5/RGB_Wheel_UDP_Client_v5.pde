...
import controlP5.*;                                                                 // Importamos libreria para poder utilizar elementos GUI en Processing (Botones, Textfields, etc)


UDP udp;                                                                            // Definimos un objeto UDP 
ControlP5 cp5;                                                                      // Definimos un objeto ControlP% para trabajar con el textfield

Textfield myTextfield_IP;                                                           // Creamos nuestro Textfield. Aqui  almacenaremos la IP del servidor 
Textfield myTextfield_PORT;                                                         // Creamos nuestro Textfield. Aqui  almacenaremos el Puerto del servidor 
...
void setup() 
{
  ...
  cp5 = new ControlP5(this);                                                        // Inicializamos nuestro Objeto cp5
  ...
  myTextfield_IP   = cp5.addTextfield("IP SERVIDOR").setPosition((displayWidth/2)-150,displayHeight-100).setSize(300,30).setFocus(true).setFont(font);
  myTextfield_PORT = cp5.addTextfield("PUERTO SERVIDOR").setPosition((displayWidth/2)-150,displayHeight-50).setSize(300,30).setFocus(true).setFont(font);
