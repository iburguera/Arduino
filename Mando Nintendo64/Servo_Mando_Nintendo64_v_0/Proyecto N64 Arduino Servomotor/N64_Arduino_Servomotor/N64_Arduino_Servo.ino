...
int N64_raw_dump_int[16]; // 1 received bit per byte
...
void loop()
{
   ...
   for (i=0; i<16; i++) 
   {
       ...
       N64_raw_dump_int[i]=N64_raw_dump[i];
   }
    Serial.print(' ');
...
//Serial.println(N64_status.stick_y, DEC);
     ...
     if(N64_raw_dump_int[0]==4)
     {
                                        // Movemos el servo varias posiciones a la izquierda
         myservo.write(2);
...
void printValuesInt()
{
    Serial.print(N64_raw_dump_int[0]);            // A
    Serial.print(N64_raw_dump_int[1]);            // B
    Serial.print(N64_raw_dump_int[2]);            // Z
    Serial.print(N64_raw_dump_int[3]);            // START
    Serial.print(N64_raw_dump_int[4]);            // B UP
    Serial.print(N64_raw_dump_int[5]);            // B DOWN
    Serial.print(N64_raw_dump_int[6]);            // A LEFT
    Serial.print(N64_raw_dump_int[7]);            // A RIGHT
    
    Serial.print(' ');
    Serial.print(' ');
    
    Serial.print(N64_raw_dump_int[8]);            // 0
    Serial.print(N64_raw_dump_int[9]);            // 0
    
    Serial.print(N64_raw_dump_int[10]);           // L
    Serial.print(N64_raw_dump_int[11]);           // R
    Serial.print(N64_raw_dump_int[12]);           // C UP
    Serial.print(N64_raw_dump_int[13]);           // C DOWN
    Serial.print(N64_raw_dump_int[14]);           // C LEFT
    Serial.print(N64_raw_dump_int[15]);           // C RIGHT
